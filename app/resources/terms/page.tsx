import React from "react";
    ...
    <article className="prose prose-lg max-w-none">
        ...
        <p className="text-2xl my-2">Accounts and Registration</p>
        <p>
        ...
        <p>
            LogZilla Corporation<br />
            ATTN: Legal Department (Copyright Notification)<br />
            166 Hargraves Dr., Ste. C400-218, Austin, TX, 78737
        </p>
        <p>
        ...
        <ul className="list-disc pl-6">
            ...
            <li>A statement by you that you have a good faith belief that the use of those materials on the Service is not authorized by the copyright owner, its agent, or the law; and</li>
        ...
        <ul className="list-disc pl-6">
            ...
            <li>Post, upload, or distribute any User Content or other content that is unlawful, defamatory, libelous, inaccurate, or that a reasonable person could deem to be objectionable, profane, indecent, pornographic, harassing, threatening, embarrassing, hateful, or otherwise inappropriate;</li>
            <li>Interfere with security-related features of the Service, including by: (a) disabling or circumventing features that prevent or limit use or copying of any content; or (b) reverse engineering or otherwise attempting to discover the source code of any portion of the Service except to the extent that the activity is expressly permitted by applicable law;</li>
            <li>Interfere with the operation of the Service or any user&apos;s enjoyment of the Service, including by: (a) uploading or otherwise disseminating any virus, adware, spyware, worm, or other malicious code; (b) making any unsolicited offer or advertisement to another user of the Service; (c) attempting to collect personal information about another user or third party without consent; or (d) interfering with or disrupting any network, equipment, or server connected to or used to provide the Service, or violating any regulation, policy, or procedure of any such network, equipment, or server;</li>
            <li>Perform any fraudulent activity including impersonating any person or entity, claiming a false affiliation, accessing any other Service account without permission, or falsifying your age or date of birth;</li>
            <li>Sell or otherwise transfer the access granted under these Terms or any Materials (as defined in Section 12) or any right or ability to view, access, or use any Material; or</li>
            <li>Attempt to do any of the acts described in this Section 7, or assist or permit any person in engaging in any of the acts described in this Section 7.</li>
        </ul>
        ...
        <p>
            Please read the LogZilla Privacy policy carefully for information relating to our collection, use, storage and disclosure of your personal information. The LogZilla Privacy Policy is incorporated by this reference into, and made a part of, these Terms.
        </p>
        ...
        <p className="text-2xl my-2">Limitation of Liability</p>
        <p>
        ...
        <p className="text-2xl my-2">Governing Law</p>
        <p>
        ...
        <p className="text-2xl my-2">Consent to Electronic Communications</p>
        <p>
            By using the Service, you consent to receiving certain electronic communications from us as further described in our Privacy Policy. Please read our Privacy Policy to learn more about our electronic communications practices. You agree that any notices, agreements, disclosures, or other communications that we send to you electronically will satisfy any legal communication requirements, including that those communications be in writing.
        </p>
        <p>
            <strong>Contact Information.</strong> The Service is offered by LogZilla Corporation, located at 166 Hargraves Dr., Ste. C400-218, Austin, TX, 78737.<br />
            You may contact us by sending correspondence to that address or by emailing us at support@/spambot-remove/logzilla.net.
        </p>
    </article>
    </section>
    );
