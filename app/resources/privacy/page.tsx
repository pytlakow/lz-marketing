...
const PrivacyPage: React.FC = () => (
   <section className="bg-[#fafafa] container mx-auto text-gray-700 max-w-7xl px-4 sm:px-6 lg:px-8">
    ...
    <article className="prose prose-lg max-w-none">
        ...
        <p>
            We may collect personal identification information from Users when Users visit our site, register on the site, place an order, subscribe to the newsletter, respond to a survey, fill out a form, and in connection with other activities, services, features or resources we make available on our Site.
        </p>
        <p>
            We collect Personal Information such as: name, email address, mailing address, and phone number.
        </p>
        <p className="text-2xl my-2">Personal Information We Collect Automatically From Your Use of the Services</p>
        <p>
        ...
        <ul>
            <li>
                <strong>To provide and improve customer service:</strong> Information you provide helps us respond to your customer service requests and support needs more efficiently.
            </li>
            <li>
                <strong>To provide and improve our Services:</strong> We and our service providers use Personal Information that we collect on the site to operate, provide, and maintain the Services, to monitor and analyze usage of the Services, and to improve our products and services.
            </li>
            <li>
                <strong>To process and fulfill purchases:</strong> We may use the information Users provide about themselves when placing an order to provide service to that order. We do not share this information with outside parties except to the extent necessary to provide the service.
            </li>
            <li>
            ...
            <li>
                <strong>Advertising:</strong> We and our advertising partners may use your Personal Information, including your location and your activities on the Site to facilitate the delivery of advertisements.
            </li>
            <li>
                <strong>Legal:</strong> We may use your Personal Information to enforce our Terms of Service, to defend our legal rights, or to comply with our legal obligations and internal policies.
            </li>
        </ul>
        <p>
        ...
        <p className="text-2xl my-2">How we protect your information</p>
        <p>
        ...
        <p>
            Please be aware that no security measures are perfect or impenetrable and thus we cannot and do not guarantee the security of your data.
        </p>
        ...
        <p className="text-2xl my-2">Your Rights and Choices</p>
        <p>
            <strong>Marketing Communications.</strong> If you decide at any time that you no longer wish to receive marketing communications from us, please follow the unsubscribe instructions provided in any of the communications. You may also opt out from receiving commercial email from us by contacting us. Please be aware that, even after you opt out from receiving commercial messages from us, you may continue to receive administrative messages from us regarding the Site.
        </p>
        <p>
        ...
        <p>
            Logzilla is based in the United States. Personal Information that we collect may be transferred to, and stored at, any of our affiliates, partners or service providers which may be inside or outside the European Economic Area, including the United States. By submitting your personal data, you agree to such transfers.
        </p>
        <p className="text-2xl my-2">Changes to this privacy policy</p>
        <p>
            Logzilla Corp has the discretion to update this privacy policy at any time. When we do, we will revise the updated date at the top of this page. We encourage Users to frequently check this page for any changes to stay informed about how we are helping to protect the personal information we collect. If we make material changes, we may notify you through the Site or by sending you an email or other communication.
        </p>
        <p className="text-2xl my-2">Your acceptance of these terms</p>
        <p>
            By using this Site, you signify your acceptance of this policy. If you do not agree to this policy, please do not use our Site. Your continued use of the Site following the posting of changes to this policy will be deemed your acceptance of those changes.
        </p>
        <p className="text-2xl my-2">Contacting us</p>
        <p>
            LogZilla Corporation is the entity responsible for the processing of your Personal Information. If you have any questions about this Privacy Policy, the practices of this site, or your dealings with this site, please contact us:
        </p>
        <address>
            166 Hargraves Dr.<br />
            Ste. C400-218<br />
